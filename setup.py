...
class cmake_build_ext(build_ext):
    ...
    def build_extensions(self) -> None:
        ...
        for ext in self.extensions:
            self.configure(ext)
            targets.append(remove_prefix(ext.name, "kizuna."))
...
def get_kizuna_version() -> str:
    version = find_version(get_path("kizuna", "__init__.py"))
...
ext_modules.append(CMakeExtension(name="kizuna._C"))

if os.getenv("KIZUNA_USE_PRECOMPILED"):
    ext_modules = []

setup(
    name="kizuna",
    version=get_kizuna_version(),
    author="AlpinDale",
    license="Apache 2.0",
    description="TTS Inference Framework",
    long_description=read_readme(),
    long_description_content_type="text/markdown",
    url="https://github.com/AlpinDale/kizuna",
    project_urls={
        "GitHub": "https://github.com/AlpinDale/kizuna",
    },
    classifiers=[
